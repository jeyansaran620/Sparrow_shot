  ...
  return (
    <div>  
        ...
        <Nav navbar className="mx-auto">
          <div>
          <svg className="brandName" width="75" height="50" x="0px" y="0px" viewBox="0 0 1000 1000" enableBackground="new 0 0 1000 1000"  fill="none" xmlns="http://www.w3.org/2000/svg">
